      ...
      <div class="solve_imgList">
        <div class="solve_imgListMian w1200">
          <ul class="animated fadeInLeft" style="animation-delay: 1s;">
            ...
            <li>
              <img style="margin-top: 10px" src="../../../static/common/images/hdList2.png" alt="">
              <h6>共享</h6>
            </li>
            <li>
              <img style="margin-top: 10px" src="../../../static/common/images/hdList3.png" alt="">
              <h6>留存</h6>
            </li>
            <li>
              <img style="margin-top: 10px" src="../../../static/common/images/hdList4.png" alt="">
              <h6>督学</h6>
            </li>
          </ul>
        </div>
      ...
      <div style="background: white;" class="leftRi">
        <div class="leftRiBox w1200">
          <div class="leftRiBoxR">
            ...
            <p class="cbp">随时直播分享重要课</p>
            <p class="cbp">老师、学生、板书镜头画面灵活调整PC、手机、平板</p>
