        ...
        <div class="headerBox_center">
          ...
          <div class="headerBox_center_R">
            <ul class="headerBoxmenu">
              ...
              <li>
                <router-link to="/exhibition" tag="p">案例展示</router-link>
              </li>
              <li>
...
<style>
  ...
  .headerBox_center_R ul li div:hover {
    border-bottom: 2px solid #fff;
  }
